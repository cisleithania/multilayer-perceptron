...
{
	//имена файлов заносятся в массив, и для него делается цикл
	//который включает открытие, считывание, закрытие

	//массив, куда записывается только имя файла, которое нужно открыть. На этот массив надо ссылаться,
	//и в этот массив должен каждый цикл записываться новое название файла
	...
	//количество файлов в папке (-2 - потому что, по умолчанию выводится число на два больше)
	cout << "Количество файлов в папке: " << iter - 2 << endl; 
